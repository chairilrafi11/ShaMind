...
public class OnBoradingScreen extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_on_borading_screen);
    ...
    public void addDotsIndicator(int position){
        ...
        for (int i = 0; i< mDots.length; i++){
            ...
            mDots[i].setTextColor(getResources().getColor(R.color.white1));
        ...
        switch (v.getId()){
            case R.id.btn_next:
                if (buttonNext.getText().toString().equalsIgnoreCase("next")){
                    ...
                    startActivity(new Intent(OnBoradingScreen.this, Login.class));
                }
                break;
